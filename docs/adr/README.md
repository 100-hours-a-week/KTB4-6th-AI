...
| [ADR-005](0005-live-audio-decoding-location.md)         | 실시간 녹음 음성을 AI 서버에서 PCM으로 변환                   | Accepted |
| [ADR-006](0006-live-audio-decoder-ffmpeg-subprocess.md) | 실시간 녹음 음성을 ffmpeg 서브프로세스로 디코딩              | Accepted |
